...
class PatientRecord(models.Model):
    ...
    def calculateMethabolicRate(self, author):
        ...
        if self.is_athlete and author == 'Pollok':
            ...
            if self.patient.biological_sex == 0:
                self.tinsley_athlete_non_fat = 25.9*self.corporal_mass*(1 - self.body_fat_woman) + 284
                self.cunningham_athlete = 22*self.corporal_mass*(1 - self.body_fat_woman) + 500
            else:
                self.tinsley_athlete_non_fat = 25.9 * self.corporal_mass * (1 - self.body_fat_man_pollok) + 284
                self.cunningham_athlete = 22 * self.corporal_mass * (1 - self.body_fat_man_pollok) + 500
            ...
            if self.patient.biological_sex == 0:
                ...
                self.tinsley_athlete_non_fat = 25.9 * self.corporal_mass * (1 - self.body_fat_man_faulkner) + 284
                self.cunningham_athlete = 22 * self.corporal_mass * (1 - self.body_fat_man_faulkner) + 500
